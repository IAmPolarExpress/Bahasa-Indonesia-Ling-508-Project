...
VALUES
    /*('laki-laki', 'MALAY', N'ˈlakilaki', 1, 'laki-laki'),
    ('untuk', 'MALAY', N'ˈuntuk', 2, 'untuk'),
    ('belajar', 'MALAY', N'bəˈladʒar', 3, 'bəlajar');*/
    ('laki-laki', 'MALAY', N'test', 1, 'laki-laki'),
    ('untuk', 'MALAY', N'test', 2, 'untuk'),
    ('belajar', 'MALAY', N'test', 3, 'bəlajar');
